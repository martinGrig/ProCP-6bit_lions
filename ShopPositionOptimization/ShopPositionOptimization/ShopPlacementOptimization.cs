...
namespace ShopPositionOptimization
{
    class ShopPlacementOptimization
    {
        ...
        private Dictionary<int, string> shopPositions; //Shop, Position
        ...
        {
            //Sort(shopResults, IComparer)  //sort by position
            //double[] shopRevenues;
            //string[] shopNames;
            ...
            //case position = 1
            //if (shopRevenues[position-1]<row.revenue)
            //shopRevenues[position-1]=row.revenue //change the highest income for position 1
            //shopNames[position-1] = row.shopname // change the highest income shop for position 1

            //case position = 2
            //if (shopRevenue[position-1]<row.revenue)
            //shopRevenues[position-1]=row.revenue //change the highest income for position 1
            //shopNames[position-1] = row.shopname // change the highest income shop for position 1
            ...
            // {
            //     if  (entry.Key == 1 && entry.Value != row.shopname && max1 < row.revenue)
            //     {
            //         //max1=row.revenue
            //         //shop1 = row.shopname
            //     }
            //     if (entry.Key == 2 && entry.Value != row.shopname && max2 < row.revenue)
            //     {
            //         //max1=row.revenue
            //         //shop1 = row.shopname
            //     }
